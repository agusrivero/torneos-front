        ...
        <View style={commonStyles.compContainer}>
            ...
            <View style={commonStyles.mainContainer}>
                <View style={styles.container}>
                    ...
                    <TextInput autoCompleteType="password" style={styles.input} placeholder="Constraseña" value={pwd} onChangeText={text => setPwd(text)}/>
                </View>
                <View style={styles.buttonContainer}>
                    <StyledButton textColor="#0B569E" color="#edff21" type="Siguiente" onPress={login}/>
                </View>
            </View>
        </View>
    )
